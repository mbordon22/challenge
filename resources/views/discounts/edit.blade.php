        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    {{ __('table.title_form_edit') }}
                </h2>
                <p class="text-sm dark:text-gray-200">
                    {{ __('table.description_form_edit') }}
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="w-full mb-6 py-5">
                        <form action="{{route('discounts.update', $discount)}}" method="POST" autocomplete="off">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="md:flex md:flex-wrap md:justify-between shadow shadow-gray-900 rounded my-4 px-3 py-4">
                                ...
                                <div class="w-full md:w-1/4 px-3">
                                    ...
                                    <x-select-input name="access_type_code" class="mt-1">
                                        ...
                                        <option value="{{$access_type->code}}" {{($discount->access_type_code == $access_type->code) ? 'selected' : ''}}>{{$access_type->name}}</option>
                                        @endforeach
                                    </x-select-input>
                                </div>
                                ...
                                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                                    ...
                                    <x-text-input class="block mt-1 w-full" id="grid-first-name" type="number"
                                        name="priority" value="{{$discount->priority}}" min="1" />
                            ...
                            <div class="md:flex md:items-center md:justify-between my-4 py-4 gap-4">
                                <x-discount-form-period-edit :index="0" :discount="$discount" />
                                <x-discount-form-period-edit :index="1" :discount="$discount" />
                                <x-discount-form-period-edit :index="2" :discount="$discount" />
                            </div>
