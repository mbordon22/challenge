<div class="md:flex md:items-center md:flex-wrap md:justify-between md:w-1/3 shadow shadow-gray-900 rounded px-3 py-4">
    ...
    <div class="w-full px-3 mb-6 md:mb-2">
        ...
        <div class="flex items-center justify-between gap-2">
            <x-text-input class="block mt-1 w-1/2 input-period" data-index="{{$index}}" type="number" name="from_days[]" :value="old('from_days.' . $index)" placeholder="Desde..."/>
            
            @error('from_days.' . $index)
            <x-input-error :messages="$errors->get('from_days.' . $index)" class="mt-2" />
            @enderror
    
            <x-text-input class="block mt-1 w-1/2 input-period" data-index="{{$index}}" type="number" name="to_days[]" :value="old('to_days.' . $index)" placeholder="Hasta..."/>
    ...
    <div class="w-full px-3 mb-6 md:mb-2">
        ...
        <x-text-input class="block mt-1 w-full input-period" data-index="{{$index}}" type="text" name="code[]" :value="old('code.' . $index)" placeholder="Código..."/>
    ...
    <div class="w-full px-3 mb-6 md:mb-0">
        ...
        <x-text-input class="block mt-1 w-full input-period" data-index="{{$index}}" type="number" name="discount[]" :value="old('discount.' . $index)" placeholder="Porcentaje..."/>
